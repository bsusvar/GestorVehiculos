...
public class Constantes {
	...
	// Expresión regular compuesta de un primer carácter de tipo letra, cuatro
		...
		// matrículas antiguas:
		public static final String[] PROVINCIAS_UNA_LETRA = new String[] { "A", "B", "C", "H", "J", "L", "M", "O", "P", "S", "T",
				"U", "Z" };

		// Array de provincias que emplean dos letras para identificarse en matrículas
		// antiguas:
		public static final String[] PROVINCIAS_DOS_LETRAS = new String[] { "VI", "AB", "AL", "AV", "BA", "PM", "BU", "CC", "CA",
